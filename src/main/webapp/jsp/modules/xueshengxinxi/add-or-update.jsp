...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>学生性别</label>
										<select id="xueshengxingbieSelect" name="xueshengxingbie" class="form-control">
												<option value=""></option>
												<option class="xueshengxingbieOption" value="男">
													男
												</option>
												<option class="xueshengxingbieOption" value="女">
													女
												</option>
										</select>	
									</div>	
	...
	<script>
		...
		function dataBind(){
			...
			var xueshengxingbieOptions = document.getElementsByClassName("xueshengxingbieOption");
			for(var xueshengxingbieCount = 0; xueshengxingbieCount < xueshengxingbieOptions.length;xueshengxingbieCount++){
				if(xueshengxingbieOptions[xueshengxingbieCount].getAttribute('value') == ruleForm.xueshengxingbie){
					xueshengxingbieOptions[xueshengxingbieCount].setAttribute('selected','selected');
				}
			}
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xueshengxingbie != null && res.data.xueshengxingbie != ''){

					var xueshengxingbieOptions = document.getElementsByClassName("xueshengxingbieOption");
						for(var xueshengxingbieCount = 0; xueshengxingbieCount < xueshengxingbieOptions.length;xueshengxingbieCount++){
							if(xueshengxingbieOptions[xueshengxingbieCount].getAttribute('value') == res.data.xueshengxingbie){
								xueshengxingbieOptions[xueshengxingbieCount].setAttribute('selected','selected');
							}
						}
					}
